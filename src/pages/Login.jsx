  ...
  return (
    <FormLayout>
      ...
      >
        ...
        <div className="my-6 font-medium text-center sm:my-4">
        ...
        <div className="flex flex-col gap-4 mb-8 sm:mb-5">
          <Input
            type="text"
            label="Email"
            name="email"
        ...
        <div className="flex items-center justify-end mb-6 text-sm font-medium select-none text-primary dark:text-white">
